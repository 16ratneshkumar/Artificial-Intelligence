...
## 5. Learning Agents
**"How can I improve my behavior based on experience?"**
...
3.  **Critic:** Observes the world and provides feedback to the learning element on how the agent is doing relative to a fixed performance standard.
4.  **Problem Generator:** Suggests actions that will lead to new and informative experiences (exploration).

### Example: Learning to Play a Game
*   **Performance Element:** Playing a move.
*   **Critic:** Noting that the move led to losing a piece (negative feedback).
*   **Learning Element:** Updating the strategy to avoid that move in the future.
*   **Problem Generator:** Suggesting a new opening to see if it works better.

---

## Summary of Agent Structures

| Agent Type | Knowledge Used | Environment Requirement | Main Process |
| :--- | :--- | :--- | :--- |
| **Simple Reflex** | Condition-action rules | Fully observable | Match current percept to rule |
| **Model-Based** | Internal state + Model | Partially observable | Update state, then match rule |
| **Goal-Based** | Goals + Consequences | Predictable | Search and Planning |
| **Utility-Based** | Utility function (Happiness) | Multiple solutions | Maximize expected utility |
| **Learning** | Feedback + Exploration | Unknown | Improve over time |

---

**Previous:** [← Intelligent Agents](04_Intelligent_Agents.md) | **Next:** [Environment Properties →](06_Environment_Properties.md)
