...
- **Logical Consequence:** A sentence `Q` is a **logical consequence** of `P` (P ⊨ Q) if every interpretation that satisfies `P` also satisfies `Q`.
...
**Previous:** [← Constraint Satisfaction Problems](16_Constraint_Satisfaction_Problems.md) | **Next:** [First-Order Predicate Logic →](18_First_Order_Predicate_Logic.md)
