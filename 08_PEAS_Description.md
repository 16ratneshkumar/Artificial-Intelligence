...
- **Performance:** Safe trip, fast transport, legal driving, passenger comfort, profit
- **Environment:** Urban roads, highways, pedestrians, traffic, weather, other vehicles
- **Actuators:** Steer, accelerate, brake, signal, honk, display screen
- **Sensors:** Cameras, GPS, speedometer, odometer, engine sensors, accelerometer, sonar

### Example 2: Medical Diagnosis System
- **Performance:** Patient health improved, minimize cost/pain, accuracy of diagnosis
- **Environment:** Hospital, patient interaction, medical staff, digital medical records
- **Actuators:** Display screen, order tests, treat, prescribe, referrals
- **Sensors:** Keyboard input (symptoms), lab results, medical history
...
### Example 4: Internet Shopping Agent
...
### Example 5: Autonomous Mars Rover
...
- **Sensors:** Camera, joint angle sensors, force sensors, touch sensors

### Example 7: Interactive English Tutor
- **Performance:** Student learns English, high test scores
- **Environment:** Computer screen, keyboard, student
- **Actuators:** Display exercises, give feedback, show corrections
- **Sensors:** Student's typed words/answers
...
**Previous:** [← PAGE Description](07_PAGE_Description.md) | **Next:** [Problem Solving Agents →](09_Problem_Solving_Agents.md)
